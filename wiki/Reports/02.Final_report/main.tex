...
\section{Documentation resources}
  ...
  \input{./sections/00.doc_resources/text.tex}
  ...
  \section{Tracking the centerline of a lane using a PID controller}
    ...
    \subsection{Experimental results}
      \input{./sections/01.centerline_pid/experimental.tex}
  ...
  \section{Tracking the centerline of a lane using a MPC controller}
    ...
    \subsection{Experimental results}
      \input{./sections/02.centerline_mpc/experimental.tex}
  ...
  \section{On the dynamic model}
    \input{./sections/04.dynamic_model/text.tex}

  \newpage

  \section{Conclusion}
    \input{./sections/05.conclusion/text.tex}
